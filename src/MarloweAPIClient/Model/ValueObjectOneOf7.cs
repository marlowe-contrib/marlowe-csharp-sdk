...
namespace MarloweAPIClient.Model
{
    ...
    /// ValueObjectOneOf7
    /// </summary>
    [DataContract(Name = "ValueObject_oneOf_7")]
    public partial class ValueObjectOneOf7 : IEquatable<ValueObjectOneOf7>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueObjectOneOf7" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValueObjectOneOf7() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueObjectOneOf7" /> class.
        /// </summary>
        ...
        public ValueObjectOneOf7(ValueObject varElse = default(ValueObject), ObservationObject varIf = default(ObservationObject), ValueObject then = default(ValueObject))
        {
            // to ensure "varElse" is required (not null)
            if (varElse == null)
            {
                throw new ArgumentNullException("varElse is a required property for ValueObjectOneOf7 and cannot be null");
            }
            this._VarElse = varElse;
            // to ensure "varIf" is required (not null)
            if (varIf == null)
            {
                throw new ArgumentNullException("varIf is a required property for ValueObjectOneOf7 and cannot be null");
            }
            this._VarIf = varIf;
            // to ensure "then" is required (not null)
            if (then == null)
            {
                throw new ArgumentNullException("then is a required property for ValueObjectOneOf7 and cannot be null");
            }
            this._Then = then;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ValueObjectOneOf7 {\n");
        ...
        {
            return this.Equals(input as ValueObjectOneOf7);
        }

        /// <summary>
        /// Returns true if ValueObjectOneOf7 instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueObjectOneOf7 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueObjectOneOf7 input)
        {
            if (input == null)
            {
                return false;

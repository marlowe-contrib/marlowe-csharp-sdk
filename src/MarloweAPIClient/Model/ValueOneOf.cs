...
namespace MarloweAPIClient.Model
{
    ...
    /// ValueOneOf
    /// </summary>
    [DataContract(Name = "Value_oneOf")]
    public partial class ValueOneOf : IEquatable<ValueOneOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueOneOf" /> class.
        /// </summary>
        ...
        public ValueOneOf(Token amountOfToken = default(Token), Party inAccount = default(Party))
        {
            // to ensure "amountOfToken" is required (not null)
            if (amountOfToken == null)
            {
                throw new ArgumentNullException("amountOfToken is a required property for ValueOneOf and cannot be null");
            }
            this._AmountOfToken = amountOfToken;
            // to ensure "inAccount" is required (not null)
            if (inAccount == null)
            {
                throw new ArgumentNullException("inAccount is a required property for ValueOneOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as ValueOneOf);
        }

        /// <summary>
        /// Returns true if ValueOneOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ValueOneOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValueOneOf input)
        {
            if (input == null)
            {
                return false;

...
namespace MarloweAPIClient.Model
{
    ...
    public partial class ContractObject : AbstractOpenAPISchema, IEquatable<ContractObject>, IValidatableObject
    {
        ...
        public ContractObject(ValueObjectOneOf8 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ContractObjectOneOf))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ContractObjectOneOf, ContractObjectOneOf1, ContractObjectOneOf2, ContractObjectOneOf3, ContractObjectOneOf4, ValueObjectOneOf8, string");
                }
            }
        }
        ...
        public static ContractObject FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newContractObject = new ContractObject(JsonConvert.DeserializeObject<ValueObjectOneOf8>(jsonString, ContractObject.SerializerSettings));
                }
                else
                {
                    newContractObject = new ContractObject(JsonConvert.DeserializeObject<ValueObjectOneOf8>(jsonString, ContractObject.AdditionalPropertiesSerializerSettings));
                }

...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Bound")]
    public partial class Bound : IEquatable<Bound>, IValidatableObject
    {
        /// <summary>
        ...
        public Bound(int from = default(int), int to = default(int))
        {
            this._From = from;
            this._To = to;
        }
        ...
        {
            return this.Equals(input as Bound);
        }

        /// <summary>
        /// Returns true if Bound instances are equal
        /// </summary>
        /// <param name="input">Instance of Bound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Bound input)
        {
            if (input == null)
            {
                return false;

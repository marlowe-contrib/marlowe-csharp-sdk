...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CaseMerkleizedThenObject")]
    public partial class CaseMerkleizedThenObject : IEquatable<CaseMerkleizedThenObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseMerkleizedThenObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaseMerkleizedThenObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseMerkleizedThenObject" /> class.
        /// </summary>
        /// <param name="varCase">varCase (required).</param>
        /// <param name="merkleizedThen">merkleizedThen (required).</param>
        public CaseMerkleizedThenObject(ActionObject varCase = default(ActionObject), string merkleizedThen = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaseMerkleizedThenObject {\n");
        ...
        {
            return this.Equals(input as CaseMerkleizedThenObject);
        }

        /// <summary>
        /// Returns true if CaseMerkleizedThenObject instances are equal
        /// </summary>
        /// <param name="input">Instance of CaseMerkleizedThenObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseMerkleizedThenObject input)
        {
            if (input == null)
            {
                return false;

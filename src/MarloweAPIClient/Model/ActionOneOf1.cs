...
namespace MarloweAPIClient.Model
{
    ...
    /// ActionOneOf1
    /// </summary>
    [DataContract(Name = "Action_oneOf_1")]
    public partial class ActionOneOf1 : IEquatable<ActionOneOf1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionOneOf1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ActionOneOf1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionOneOf1" /> class.
        /// </summary>
        /// <param name="chooseBetween">chooseBetween (required).</param>
        /// <param name="forChoice">forChoice (required).</param>
        public ActionOneOf1(List<Bound> chooseBetween = default(List<Bound>), ChoiceId forChoice = default(ChoiceId))
        {
            // to ensure "chooseBetween" is required (not null)
            if (chooseBetween == null)
            {
                throw new ArgumentNullException("chooseBetween is a required property for ActionOneOf1 and cannot be null");
            }
            this._ChooseBetween = chooseBetween;
            // to ensure "forChoice" is required (not null)
            if (forChoice == null)
            {
                throw new ArgumentNullException("forChoice is a required property for ActionOneOf1 and cannot be null");
            }
        ...
        {
            return this.Equals(input as ActionOneOf1);
        }

        /// <summary>
        /// Returns true if ActionOneOf1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionOneOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionOneOf1 input)
        {
            if (input == null)
            {
                return false;

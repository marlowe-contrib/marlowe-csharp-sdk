...
namespace MarloweAPIClient.Model
{
    ...
    /// DivideObject
    /// </summary>
    [DataContract(Name = "DivideObject")]
    public partial class DivideObject : IEquatable<DivideObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DivideObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DivideObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DivideObject" /> class.
        /// </summary>
        /// <param name="by">by (required).</param>
        /// <param name="divide">divide (required).</param>
        public DivideObject(ValueObject by = default(ValueObject), ValueObject divide = default(ValueObject))
        {
        ...
        {
            return this.Equals(input as DivideObject);
        }

        /// <summary>
        /// Returns true if DivideObject instances are equal
        /// </summary>
        /// <param name="input">Instance of DivideObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DivideObject input)
        {
            if (input == null)
            {
                return false;

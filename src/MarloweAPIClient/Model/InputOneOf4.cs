...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Input_oneOf_4")]
    public partial class InputOneOf4 : IEquatable<InputOneOf4>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InputOneOf4" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InputOneOf4() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InputOneOf4" /> class.
        /// </summary>
        ...
        public InputOneOf4(Party inputFromParty = default(Party), Party intoAccount = default(Party), Token ofToken = default(Token), int thatDeposits = default(int))
        {
            // to ensure "inputFromParty" is required (not null)
            if (inputFromParty == null)
            {
                throw new ArgumentNullException("inputFromParty is a required property for InputOneOf4 and cannot be null");
            }
            this._InputFromParty = inputFromParty;
            // to ensure "intoAccount" is required (not null)
            if (intoAccount == null)
            {
                throw new ArgumentNullException("intoAccount is a required property for InputOneOf4 and cannot be null");
            }
            this._IntoAccount = intoAccount;
            // to ensure "ofToken" is required (not null)
            if (ofToken == null)
            {
                throw new ArgumentNullException("ofToken is a required property for InputOneOf4 and cannot be null");
            }
        ...
        {
            return this.Equals(input as InputOneOf4);
        }

        /// <summary>
        /// Returns true if InputOneOf4 instances are equal
        /// </summary>
        /// <param name="input">Instance of InputOneOf4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InputOneOf4 input)
        {
            if (input == null)
            {
                return false;

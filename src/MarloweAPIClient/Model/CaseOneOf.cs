...
namespace MarloweAPIClient.Model
{
    ...
    /// CaseOneOf
    /// </summary>
    [DataContract(Name = "Case_oneOf")]
    public partial class CaseOneOf : IEquatable<CaseOneOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseOneOf" /> class.
        /// </summary>
        ...
        public CaseOneOf(Action varCase = default(Action), Contract then = default(Contract))
        {
            // to ensure "varCase" is required (not null)
            if (varCase == null)
            {
                throw new ArgumentNullException("varCase is a required property for CaseOneOf and cannot be null");
            }
            this._VarCase = varCase;
            // to ensure "then" is required (not null)
            if (then == null)
            {
                throw new ArgumentNullException("then is a required property for CaseOneOf and cannot be null");
            }
            this._Then = then;
        }
        ...
        {
            return this.Equals(input as CaseOneOf);
        }

        /// <summary>
        /// Returns true if CaseOneOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CaseOneOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaseOneOf input)
        {
            if (input == null)
            {
                return false;

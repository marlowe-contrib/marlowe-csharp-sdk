...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PartialPayment")]
    public partial class PartialPayment : IEquatable<PartialPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialPayment" /> class.
        /// </summary>
        ...
        public PartialPayment(Party account = default(Party), int askedToPay = default(int), int butOnlyPaid = default(int), Token ofToken = default(Token), Payee toPayee = default(Payee))
        {
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for PartialPayment and cannot be null");
            }
            ...
            if (ofToken == null)
            {
                throw new ArgumentNullException("ofToken is a required property for PartialPayment and cannot be null");
            }
            this.OfToken = ofToken;
            // to ensure "toPayee" is required (not null)
            if (toPayee == null)
            {
                throw new ArgumentNullException("toPayee is a required property for PartialPayment and cannot be null");
            }
        ...
        public int ButOnlyPaid { get; set; }
        ...
        {
            return this.Equals(input as PartialPayment);
        }

        /// <summary>
        /// Returns true if PartialPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of PartialPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartialPayment input)
        {
            if (input == null)
            {
                return false;

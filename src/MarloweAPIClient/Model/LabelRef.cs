...
namespace MarloweAPIClient.Model
{
    ...
    /// LabelRef
    /// </summary>
    [DataContract(Name = "LabelRef")]
    public partial class LabelRef : IEquatable<LabelRef>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelRef" /> class.
        /// </summary>
        ...
        public LabelRef(string varRef = default(string))
        {
        ...
        {
            return this.Equals(input as LabelRef);
        }

        /// <summary>
        /// Returns true if LabelRef instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelRef to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelRef input)
        {
            if (input == null)
            {
                return false;

...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ObservationObject_oneOf_1")]
    public partial class ObservationObjectOneOf1 : IEquatable<ObservationObjectOneOf1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObservationObjectOneOf1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ObservationObjectOneOf1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ObservationObjectOneOf1" /> class.
        /// </summary>
        /// <param name="either">either (required).</param>
        /// <param name="or">or (required).</param>
        public ObservationObjectOneOf1(ObservationObject either = default(ObservationObject), ObservationObject or = default(ObservationObject))
        {
            // to ensure "either" is required (not null)
            if (either == null)
            {
                throw new ArgumentNullException("either is a required property for ObservationObjectOneOf1 and cannot be null");
            }
            this._Either = either;
            // to ensure "or" is required (not null)
            if (or == null)
            {
                throw new ArgumentNullException("or is a required property for ObservationObjectOneOf1 and cannot be null");
            }
            this._Or = or;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ObservationObjectOneOf1 {\n");
        ...
        {
            return this.Equals(input as ObservationObjectOneOf1);
        }

        /// <summary>
        /// Returns true if ObservationObjectOneOf1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ObservationObjectOneOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObservationObjectOneOf1 input)
        {
            if (input == null)
            {
                return false;

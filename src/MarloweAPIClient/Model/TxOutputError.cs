...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TxOutputError")]
    public partial class TxOutputError : IEquatable<TxOutputError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TxOutputError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TxOutputError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TxOutputError" /> class.
        /// </summary>
        /// <param name="transactionError">transactionError (required).</param>
        public TxOutputError(TransactionError transactionError = default(TransactionError))
        {
        ...
        {
            return this.Equals(input as TxOutputError);
        }

        /// <summary>
        /// Returns true if TxOutputError instances are equal
        /// </summary>
        /// <param name="input">Instance of TxOutputError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxOutputError input)
        {
            if (input == null)
            {
                return false;

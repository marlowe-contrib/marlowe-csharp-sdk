...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IfObject")]
    public partial class IfObject : IEquatable<IfObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IfObject" /> class.
        /// </summary>
        ...
        public IfObject(ContractObject varElse = default(ContractObject), ObservationObject varIf = default(ObservationObject), ContractObject then = default(ContractObject))
        {
        ...
        {
            return this.Equals(input as IfObject);
        }

        /// <summary>
        /// Returns true if IfObject instances are equal
        /// </summary>
        /// <param name="input">Instance of IfObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IfObject input)
        {
            if (input == null)
            {
                return false;

...
namespace MarloweAPIClient.Model
{
    ...
    public partial class ActionObject : AbstractOpenAPISchema, IEquatable<ActionObject>, IValidatableObject
    {
        ...
        public ActionObject(ValueObjectOneOf8 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ActionOneOf, ActionOneOf1, ActionOneOf2, ValueObjectOneOf8");
                }
            }
        }
        ...
        public static ActionObject FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newActionObject = new ActionObject(JsonConvert.DeserializeObject<ValueObjectOneOf8>(jsonString, ActionObject.SerializerSettings));
                }
                else
                {
                    newActionObject = new ActionObject(JsonConvert.DeserializeObject<ValueObjectOneOf8>(jsonString, ActionObject.AdditionalPropertiesSerializerSettings));
                }

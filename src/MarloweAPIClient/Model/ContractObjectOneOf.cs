...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContractObject_oneOf")]
    public partial class ContractObjectOneOf : IEquatable<ContractObjectOneOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContractObjectOneOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContractObjectOneOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContractObjectOneOf" /> class.
        /// </summary>
        ...
        public ContractObjectOneOf(PartyObject fromAccount = default(PartyObject), ValueObject pay = default(ValueObject), ContractObject then = default(ContractObject), PayeeObject to = default(PayeeObject), TokenObject token = default(TokenObject))
        {
            // to ensure "fromAccount" is required (not null)
            if (fromAccount == null)
            {
                throw new ArgumentNullException("fromAccount is a required property for ContractObjectOneOf and cannot be null");
            }
            this._FromAccount = fromAccount;
            // to ensure "pay" is required (not null)
            if (pay == null)
            {
                throw new ArgumentNullException("pay is a required property for ContractObjectOneOf and cannot be null");
            }
            this._Pay = pay;
            // to ensure "then" is required (not null)
            if (then == null)
            {
                throw new ArgumentNullException("then is a required property for ContractObjectOneOf and cannot be null");
            }
            this._Then = then;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ContractObjectOneOf and cannot be null");
            }
            this._To = to;
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for ContractObjectOneOf and cannot be null");
            }
            this._Token = token;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContractObjectOneOf {\n");
        ...
        {
            return this.Equals(input as ContractObjectOneOf);
        }

        /// <summary>
        /// Returns true if ContractObjectOneOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ContractObjectOneOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractObjectOneOf input)
        {
            if (input == null)
            {
                return false;

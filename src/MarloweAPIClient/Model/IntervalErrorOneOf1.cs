...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IntervalError_oneOf_1")]
    public partial class IntervalErrorOneOf1 : IEquatable<IntervalErrorOneOf1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntervalErrorOneOf1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IntervalErrorOneOf1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntervalErrorOneOf1" /> class.
        /// </summary>
        /// <param name="intervalInPastError">intervalInPastError (required).</param>
        public IntervalErrorOneOf1(IntervalErrorOneOf1IntervalInPastError intervalInPastError = default(IntervalErrorOneOf1IntervalInPastError))
        {
            // to ensure "intervalInPastError" is required (not null)
            if (intervalInPastError == null)
            {
                throw new ArgumentNullException("intervalInPastError is a required property for IntervalErrorOneOf1 and cannot be null");
            }
        ...
        public IntervalErrorOneOf1IntervalInPastError IntervalInPastError
        {
        ...
        private IntervalErrorOneOf1IntervalInPastError _IntervalInPastError;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IntervalErrorOneOf1 {\n");
        ...
        {
            return this.Equals(input as IntervalErrorOneOf1);
        }

        /// <summary>
        /// Returns true if IntervalErrorOneOf1 instances are equal
        /// </summary>
        /// <param name="input">Instance of IntervalErrorOneOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntervalErrorOneOf1 input)
        {
            if (input == null)
            {
                return false;

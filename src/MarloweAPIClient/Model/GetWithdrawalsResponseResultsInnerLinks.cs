...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetWithdrawalsResponse_results_inner_links")]
    public partial class GetWithdrawalsResponseResultsInnerLinks : IEquatable<GetWithdrawalsResponseResultsInnerLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWithdrawalsResponseResultsInnerLinks" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetWithdrawalsResponseResultsInnerLinks {\n");
        ...
        {
            return this.Equals(input as GetWithdrawalsResponseResultsInnerLinks);
        }

        /// <summary>
        /// Returns true if GetWithdrawalsResponseResultsInnerLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of GetWithdrawalsResponseResultsInnerLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetWithdrawalsResponseResultsInnerLinks input)
        {
            if (input == null)
            {
                return false;

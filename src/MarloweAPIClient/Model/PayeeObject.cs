...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(PayeeObjectJsonConverter))]
    [DataContract(Name = "PayeeObject")]
    public partial class PayeeObject : AbstractOpenAPISchema, IEquatable<PayeeObject>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, PayeeObject.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of PayeeObject
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of PayeeObject</returns>
        public static PayeeObject FromJson(string jsonString)
        {
            PayeeObject newPayeeObject = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newPayeeObject;
            }
            int match = 0;
        ...
        {
            return this.Equals(input as PayeeObject);
        }

        /// <summary>
        /// Returns true if PayeeObject instances are equal
        /// </summary>
        /// <param name="input">Instance of PayeeObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayeeObject input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for PayeeObject
    /// </summary>
    public class PayeeObjectJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(PayeeObject).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return PayeeObject.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }

...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContinuationInput")]
    public partial class ContinuationInput : IEquatable<ContinuationInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContinuationInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContinuationInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContinuationInput" /> class.
        /// </summary>
        ...
        public ContinuationInput(string continuationHash = default(string), Contract merkleizedContinuation = default(Contract))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContinuationInput {\n");
        ...
        {
            return this.Equals(input as ContinuationInput);
        }

        /// <summary>
        /// Returns true if ContinuationInput instances are equal
        /// </summary>
        /// <param name="input">Instance of ContinuationInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContinuationInput input)
        {
            if (input == null)
            {
                return false;

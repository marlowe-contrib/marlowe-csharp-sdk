...
namespace MarloweAPIClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration(
            ...
            string basePath = "https://marlowe-runtime-preprod-web.scdev.aws.iohkdev.io") : this()
        {
        ...
        {
            string report = "C# SDK (MarloweAPIClient) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 0.0.5.1\n";

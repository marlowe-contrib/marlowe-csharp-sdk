...
namespace MarloweAPIClient.Model
{
    ...
    /// Greater
    /// </summary>
    [DataContract(Name = "Greater")]
    public partial class Greater : IEquatable<Greater>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Greater" /> class.
        /// </summary>
        ...
        public Greater(Value gt = default(Value), Value value = default(Value))
        {
        ...
        {
            return this.Equals(input as Greater);
        }

        /// <summary>
        /// Returns true if Greater instances are equal
        /// </summary>
        /// <param name="input">Instance of Greater to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Greater input)
        {
            if (input == null)
            {
                return false;

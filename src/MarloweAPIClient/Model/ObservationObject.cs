...
namespace MarloweAPIClient.Model
{
    ...
    public partial class ObservationObject : AbstractOpenAPISchema, IEquatable<ObservationObject>, IValidatableObject
    {
        ...
        public ObservationObject(ValueObjectOneOf8 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ObservationObjectOneOf))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ObservationObjectOneOf, ObservationObjectOneOf1, ObservationObjectOneOf2, ObservationObjectOneOf3, ObservationObjectOneOf4, ObservationObjectOneOf5, ObservationObjectOneOf6, ObservationObjectOneOf7, ObservationObjectOneOf8, ValueObjectOneOf8, bool");
                }
            }
        }
        ...
        public static ObservationObject FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newObservationObject = new ObservationObject(JsonConvert.DeserializeObject<ValueObjectOneOf8>(jsonString, ObservationObject.SerializerSettings));
                }
                else
                {
                    newObservationObject = new ObservationObject(JsonConvert.DeserializeObject<ValueObjectOneOf8>(jsonString, ObservationObject.AdditionalPropertiesSerializerSettings));
                }

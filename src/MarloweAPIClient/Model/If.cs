...
namespace MarloweAPIClient.Model
{
    ...
    public partial class If : IEquatable<If>, IValidatableObject
    {
        /// <summary>
        ...
        public If(Contract varElse = default(Contract), Observation varIf = default(Observation), Contract then = default(Contract))
        {
            // to ensure "varElse" is required (not null)
            if (varElse == null)
            {
                throw new ArgumentNullException("varElse is a required property for If and cannot be null");
            }
            this.VarElse = varElse;
            // to ensure "varIf" is required (not null)
            if (varIf == null)
            {
                throw new ArgumentNullException("varIf is a required property for If and cannot be null");
            }
            this.VarIf = varIf;
            // to ensure "then" is required (not null)
            if (then == null)
            {
                throw new ArgumentNullException("then is a required property for If and cannot be null");
            }
            this.Then = then;
        }
        ...
        public Contract VarElse { get; set; }
        ...
        {
            return this.Equals(input as If);
        }

        /// <summary>
        /// Returns true if If instances are equal
        /// </summary>
        /// <param name="input">Instance of If to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(If input)
        {
            if (input == null)
            {
                return false;

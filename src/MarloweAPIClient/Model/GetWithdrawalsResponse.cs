...
namespace MarloweAPIClient.Model
{
    ...
    public partial class GetWithdrawalsResponse : IEquatable<GetWithdrawalsResponse>, IValidatableObject
    {
        ...
        protected GetWithdrawalsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWithdrawalsResponse" /> class.
        /// </summary>
        /// <param name="results">results (required).</param>
        public GetWithdrawalsResponse(List<GetWithdrawalsResponseResultsInner> results = default(List<GetWithdrawalsResponseResultsInner>))
        {
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for GetWithdrawalsResponse and cannot be null");
            }
        ...
        public List<GetWithdrawalsResponseResultsInner> Results
        {
            get{ return _Results;}
            set
            {
        ...
        private List<GetWithdrawalsResponseResultsInner> _Results;

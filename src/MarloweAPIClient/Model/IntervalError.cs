...
namespace MarloweAPIClient.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(IntervalErrorJsonConverter))]
    [DataContract(Name = "IntervalError")]
    public partial class IntervalError : AbstractOpenAPISchema, IEquatable<IntervalError>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, IntervalError.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of IntervalError
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of IntervalError</returns>
        public static IntervalError FromJson(string jsonString)
        {
            IntervalError newIntervalError = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newIntervalError;
            }
            int match = 0;
        ...
        {
            return this.Equals(input as IntervalError);
        }

        /// <summary>
        /// Returns true if IntervalError instances are equal
        /// </summary>
        /// <param name="input">Instance of IntervalError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntervalError input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for IntervalError
    /// </summary>
    public class IntervalErrorJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(IntervalError).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return IntervalError.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
